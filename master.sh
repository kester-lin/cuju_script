...
sudo \
    ...
    -m 512M -enable-kvm \
    -net tap,ifname=tap0 -net nic,model=virtio,vlan=0,macaddr=ae:ae:01:00:00:25 \
    -vga std \
    -chardev socket,id=mon,path=/tmp/vm1.monitor,server,nowait \
    ...
    #-drive if=none,id=drive0,cache=none,format=raw,file=/home/ft/data/Ubuntu20G-1604.img \
